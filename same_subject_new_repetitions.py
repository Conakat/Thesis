...
train(model, optimizer, x_dict_train11, y_dict_train_reg11, y_train_class11, x_dict_val11, y_dict_val_reg11, y_val_class11, n_way, n_support, n_query, max_epoch, epoch_size, model_save_path, patience, min_delta, batch_size)
test_episode = 100
test(model, x_dict_test11, y_dict_test_reg11, y_test_class11, n_way, n_support, n_query, test_episode, model_load_path.format(3), batch_size)
